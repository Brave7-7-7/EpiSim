...
public final class SimConstants {
     ...
     * exports, report lines, and re-parsed numeric strings — must use DATA_LOCALE ({@link Locale#ROOT})
     * so the format is stable across machines. When reading such data back, use
     * {@link Double#parseDouble(String)}, which is always locale-independent, never a locale-sensitive
     * {@code java.text.NumberFormat}/{@code DecimalFormat}.
     */
